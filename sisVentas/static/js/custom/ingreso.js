...
function agregar(){
    ...
    precio_compra= parseFloat($("#id_form-0-precio_compra").val());
...
arrServicio = ['', 'Articulos', 'Cantidad', 'PrecioCompra', 'PrecioVenta'];
...
let validarJson = (table, nameClass, arrHeader) => {
    ...
    document.getElementById('id_detalle_ingresos').value = JSON.stringify(rows);    
}